...
const Features = () => {
    return (
        <>
            <section className="flex flex-col justify-center items-center translate-y-16 mb-32">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 p-2 gap-2 translate-y-10">
